...
import (
	...
	"poc-consumer-go-mongo-async/app/router"
	"poc-consumer-go-mongo-async/app/utils"
	"poc-consumer-go-mongo-async/infra/database"
	akafka "poc-consumer-go-mongo-async/infra/kafka/config"
	"poc-consumer-go-mongo-async/infra/kafka/consumer"
	"poc-consumer-go-mongo-async/infra/repository"
	"poc-consumer-go-mongo-async/usecase"
